 ...
 * @var \App\Model\Entity\ShipmentInout[]|\Cake\Collection\CollectionInterface $shipmentInouts
 */
?>
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">ส่งออกสินค้า</h4> 
        ...
        <div class="card-box">
            <div class="row">
                <div class="col-md-12 text-right">
                    <?= $this->Html->link(__('<i class="fa fa-cart-plus"></i> เพิ่มรายการส่งออกสินค้า'), ['action' => 'addShipment'], ['class' => 'btn btn-primary btn-rounded w-md waves-effect waves-light m-b-5', 'data-toggle' => 'modal', 'data-target' => '#addShipmentInoutModal', 'escape' => false]) ?>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document" style="max-width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addShipmentInoutModalLabel">เพิ่มรายการส่งออกสินค้าจากคลังสินค้า</h5>
            </div>
                ...
                <fieldset>
                    ...
                    <div class="row" style="padding: 20px;">
                        ...
                        <div class="col-6">
                            ...
                            <?php echo $this->Form->control('isshipment', ['type' => 'hidden', 'value' => 'Y']); ?>
                        </div>
                    </div>
                </fieldset>
                <br>
