 ...
 * @method \App\Model\Entity\RawOrder|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\RawOrder|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class RawOrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyString('orderno', false);
