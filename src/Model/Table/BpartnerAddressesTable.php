 ...
 * @method \App\Model\Entity\BpartnerAddress|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\BpartnerAddress|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
