 ...
 * @method \App\Model\Entity\ShipmentInout|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ShipmentInout|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class ShipmentInoutsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyDate('docdate', false);

        $validator
            ->scalar('isshipment')
            ->requirePresence('isshipment', 'create')
            ->allowEmptyString('isshipment', false);
